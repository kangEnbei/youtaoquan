...
@section('item')
    <div class="detail">
        ...
        <div class="image col-sm-4">
            <img src="http://gaitaobao4.alicdn.com/tfscom/i2/2843105094/TB1VK4tlbsTMeJjy1zcXXXAgXXa_!!0-item_pic.jpg_440x440.jpg">
        </div>
        <div class="intro col-sm-8">
            <div class="title">
                ...
                <span>猫人保暖内衣女情侣本命年套装</span>
            </div>

            <div class="desc">猫人天猫正品，，柔软透气，细腻亲肤，绝不褪色，超弹耐洗耐穿，情侣本命年套装，寒冷不等待！！！</div>
            ...
            <div class="price">
                ...
                <div class="some-btn">
                    <a class="go" href="https://detail.tmall.com/item.htm?id=559908291338" target="_blank">查看商品</a>
                    <div class="add-fav">收藏</div>
                </div>
            </div>

            <div class="coupon">
                优惠券<span class="red">20.0</span>元<!--，剩余<span
                    class="coupon-surplus">5000</span>张-->，2017-11-14过期
                <a href="http://shop.m.taobao.com/shop/coupon.htm?seller_id=2843105094&amp;activity_id=37913c846bfa479f864273f182273dd9" target="_blank">点击领取</a>
            </div>
